...
// ----- 600 RPM Dynamic Speed Tuning -----
#define STRAIGHT_SPEED 200    // Max speed on perfect straights
#define GENTLE_SPEED   160    // Slight curves
#define SHARP_SPEED    120    // Sharp curves
#define EXTREME_SPEED  80     // Recovering from edges
#define TURN_SPEED     170    // Outer wheel speed during 90° pivots

// ----- PID Tuning (High Inertia 600 RPM Setup) -----
#define KP  0.8               // Aggressive steering
#define KI  0.0               // 0 to prevent high-speed oscillation
#define KD  4.5               // Heavy dampening to stop wobble
